...
FrontAccounting v2.5

This is an unofficial GitHub Repo for the current unstable version of FrontAccounting maintained by me (Ap.Muthu).

It will be updated only in some of my spare time.

URL to clone this repo in Git:
````
https://github.com/apmuthu/frontac25.git
````

* [FA 2.5 Ap.Muthu Fork](https://github.com/apmuthu/frontac25)
* [FA 2.4 branch Extensions](https://github.com/apmuthu/FA24extensions) are still valid here for now
...
* [Central users forum](http://frontaccounting.com/punbb)
* [Main code repository](https://sourceforge.net/p/frontaccounting/git/ci/unstable/tree/)
* [GitHub mirror](https://github.com/FrontAccountingERP/FA/tree/unstable)
...
To clone the original repo (all branches) in Git:
````
...
Unstable branch contains all the latest bugfixes made atop the last unstable release.
